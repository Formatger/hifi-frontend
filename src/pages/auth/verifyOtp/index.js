...
// var AuthCodePage = function () {
//     return (<div className="w-[1512px] h-[982px] relative bg-white flex-col justify-start items-start inline-flex">
//             <div className="w-[126.44px] h-8 relative"/>
//             <div className="w-[1112px] text-center text-neutral-900 text-3xl  font-remove font-['Poppins'] tracking-tight">
...
//                     <div className="self-stretch text-center text-neutral-900 text-remove  font-remove font-['Poppins'] leading-normal">
...
//                             <div className="text-white text-remove  font-remove font-['Poppins'] leading-normal">Confirm</div>
//                         </div>
//                     </div>
//                 </div>
//             </div>
