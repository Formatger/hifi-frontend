      ...
      >
        ...
        >
          <Form className="">
            ...
            {verification ? (
              <>
                <div className="p-6 text-center text-[#111012] text-remove  font-remove leading-normal">
              ...
              <>
                ...
                <div className="p-4 sm:px-8 sm:py-8">
                  <div className="flex items-center justify-between flex-col sm:flex-row gap-3 lg:gap-0">
                    <p className="text-[#252C32] text-remove font-semibold leading-normal tracking-tight">
                      Old password
                    </p>
                    <div>
                      <TextInput
...
const TextInput: React.FC<TextInputProps> = ({
  ...
  return (
    <div className="relative">
      <Field
        className={`text-remove  font-remove w-full lg:w-[240px] leading-normal h-[34px] px-1.5 pt-1.5 pb-1 bg-white rounded border border-gray-400 ${
